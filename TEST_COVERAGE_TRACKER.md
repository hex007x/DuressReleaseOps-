...
| 2026-04-20 | Server UI defects: notification webhook text boxes prefilled with leading spaces and client-policy monitor/status mismatch still unresolved | Not yet | Not yet | Not yet | Newly reported manual defects. Need server-side UI fix plus regression coverage for textbox trimming/paste safety and real policy status reconciliation in the monitor |
